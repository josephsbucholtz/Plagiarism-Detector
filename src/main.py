...
if __name__ == "__main__":
    ...
    results = utils.run_comparison(declaration_text, declaration_variant)
    print("Doc 1 signature: ")
    print(results["a_sig"])
    print("\n")
    print("Doc 2 signature: ")
    print(results["b_sig"])
    print(utils.compare_signatures(results["a_sig"], results["b_sig"]))
    print(str(utils.compare_signatures(results["a_sig"], results["b_sig"]) * 100) + "% similar")
